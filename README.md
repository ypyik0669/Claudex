...
- Windows：下载 `Claudex-0.1.2.exe` 安装包，或下载 `Claudex-0.1.2.zip` 便携包。
- macOS Apple Silicon：下载 `Claudex-0.1.2-arm64.dmg`，或下载 `Claudex-0.1.2-arm64.zip`。
- macOS Intel：下载 `Claudex-0.1.2-x64.dmg`，或下载 `Claudex-0.1.2-x64.zip`。
